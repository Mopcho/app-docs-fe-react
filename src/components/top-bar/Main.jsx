...
function Main(props) {
  ...
  let {
    logout: lo,
    isLoading: loadingCurrentUserInfo,
  ...
  return (
    <>
      ...
      <div className="top-bar">
        ...
        {/* END: Notifications  */}
        {/* BEGIN: Account Menu */}
        {loadingCurrentUserInfo ? <LoadingIcon icon="circles" className="w-8 h-8" /> : !currentUserInfo && !isAuthenticated ? (
          <LoginButton />
        ) : (
          <Dropdown className="intro-x w-8 h-8">
            ...
            <DropdownMenu className="w-56">
              <DropdownContent className="bg-primary text-white">
                ...
                <DropdownDivider className="border-white/[0.08]" />
                <DropdownItem className="hover:bg-white/5" onClick={() => lo()}>
